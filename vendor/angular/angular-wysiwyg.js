...
/**
 * Modified by riki34
 * GitHub: http://github.com/riki343
...
(function (angular, undefined) {
    ...
    angular.module('wysiwyg.module', ['colorpicker.module']).directive('wysiwyg', [
        ...
        '$compile',
        '$sce',
        function ($timeout, wysiwgGui, $compile, $sce) {
            return {
            ...
            function link(scope, element, attrs, ngModelController) {
                ...
                scope.insertImage = function () {
                    ...
                    if (input && input !== undefined) {
                        textarea.focus();
                        var template = '<img class="img-responsive" src="' + input + '" />';
                        scope.format('insertHTML', template);
                    }
                };
                scope.insertYoutubeVideo = function () {
                    var input = prompt('Enter the video URL');
                    if (input && input !== undefined) {
                        input = input.replace('youtu.be/', 'www.youtube.com/embed/');
                        textarea.focus();
                        var embed =
                            '<div class="embed-responsive embed-responsive-16by9">' +
                                '<iframe class="embed-responsive-item" src="' + input +'"></iframe>' +
                            '</div>';
                        scope.format('insertHTML', embed);
                    }
                };
